class OauthController < ApplicationController
  ...
  def sign_up
    request_token = @consumer.get_request_token(oauth_callback: (Rails.env.production? ? 'http://boiling-depths-9831.herokuapp.com/' : 'http://localhost:3000/callback'))
  ...
  def contact_request 
    @consumer.get_request_token(oauth_callback: (Rails.env.production? ? 'http://boiling-depths-9831.herokuapp.com/' : 'http://localhost:3000/callback'))
